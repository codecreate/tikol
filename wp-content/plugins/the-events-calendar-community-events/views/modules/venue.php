...
<div class="tribe-events-community-details eventForm bubble" id="event_venue">
	...
	<table class="tribe-community-event-info" cellspacing="0" cellpadding="0">
		...
		<tr class="venue">
			<td>
				<label for="VenueVenue" <?php if ( $event && $_POST && empty( $venue_name ) ) echo 'class="error"'; ?>>
					<?php _e( 'Venue Name / Building Name / Level' , 'tribe-events-community' ); ?>:
				</label>
			</td>
			<td>
		...
		<tr class="venue">
			...
			<td>
				<input type="text" id="VenueAddress" name="venue[Address]" size="60" value="<?php echo $venue_address; ?>" />
			</td>
		</tr><!-- .venue -->
		...
		<tr class="venue">
			...
			<td><input type="text" id="VenueCity" name="venue[City]" size="25" value="<?php echo $venue_city; ?>" /></td>
		</tr><!-- .venue -->
		...
		<tr class="venue">
			...
			<td>
				<input id="StateProvinceText" name="venue[Province]" type="text" name="" size="25" value="<?php echo ( isset( $venue_province ) && $venue_province != '' && $venue_province != -1 ) ? $venue_province : ''; ?>" />
		...
		<tr class="venue">
			...
			<td>
				<input type="text" id="EventZip" name="venue[Zip]" size="6" value="<?php echo $venue_zip; ?>" />
			</td>
		</tr><!-- .venue -->
