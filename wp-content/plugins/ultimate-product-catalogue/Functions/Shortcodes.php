...
function AddProduct($format, $Item_ID) {
		...
		//Create the listing for the detail layout display
				...
				$ProductString .= "<div id='prod-cat-detail-div-" . $Product->Item_ID . "' class='prod-cat-detail-image-div upcp-detail-image-div'> Category > " . $Product->SubCategory_Name ;
				...
				$ProductString .= "<div id='prod-cat-desc-" . $Product->Item_ID . "' class='prod-cat-desc upcp-detail-desc'>" . substr($Product->Item_Description, 0, 10000);
				...
				$ProductString .= "' href='" . $ItemLink . "' target='_blank'>";
				$ProductString .= "<div id='prod-cat-details-link-" . $Product->Item_ID . "' class='prod-cat-details-link upcp-detail-details-link'>" . __("Purchase Online", 'UPCP') . "</div>\n";
				$ProductString .= "</a>";
				$ProductString .= "</div>";
