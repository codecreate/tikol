...
<div id="upcp_pro" class="postbox " >
		<div class="handlediv" title="Click to toggle"></div><h3 class='hndle'><span><?php _e("Pro Version", 'UPCP') ?></span></h3>
		<div class="inside">
				...
				<li><?php _e("Thanks for being an early adopter! Anyone who installs our plugin before September 30th receives the pro version free of charge!", 'UPCP') ?></li></ul>
