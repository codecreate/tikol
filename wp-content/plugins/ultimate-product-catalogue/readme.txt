...
* Exclude one or more layouts by using the "exclude_layouts" attribute (accepts a comma-separated list)
...
The attribute "exclude_layouts" lets you stop one or more layouts from being displayed. It accepts a comma separated list of layouts you wish to exclude. For example, "exclude_layouts='Thumbnail, List'" would make your catalogue display only the "Detail" view.
